    ...
    <div class="col-sm-12">
        ...
        <div id="topmenu" class="fixed">
            <ul class="dropdown clearfix boxed boxed-white">
                ...
                <li class="menu-level-0"><a href="javascript:void(0);{{--URL::route('quizes')--}}" style="outline: none;"><span>{{__('latest')}}</span></a></li>
                <li class="menu-level-0"><a href="javascript:void(0);{{--URL::route('popularQuizes')--}}" style="outline: none;"><span>{{__('popular')}}</span></a></li>
                @if($categories->count())
