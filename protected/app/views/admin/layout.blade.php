...
<html lang="en">
    ...
    <head>
        ...
        <script src="{{ URL::asset('bower_components/underscore/underscore.js')}}"></script>
                    ...
                    <ul class="nav navbar-nav side-nav">
                        ...
                        <li>
                            ...
                            <ul id="usersSubMenu" class="collapse">
                                ...
                                <li><a href="{{ route('adminQuizUsers') }}"><i class="fa fa-fw fa-users"></i> Quiz users</a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul id="configSubMenu" class="collapse">
                                ...
                                <li><a href="{{ route('adminConfigQuiz') }}"><i class="fa fa-fw fa-wrench"></i> Quiz Config</a></li>
                            </ul>
                        </li>
                        <li>
